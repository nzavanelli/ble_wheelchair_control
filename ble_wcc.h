...
#define LBS_UUID_SERVICE     0x9923
#define LBS_UUID_BUTTON_CHAR 0x9924
#define LBS_UUID_LED_CHAR    0x9925
 ...
 */
uint32_t ble_wcc_init(ble_lbs_t * p_lbs, const ble_lbs_init_t * p_lbs_init);
 ...
 */
void ble_wcc_on_ble_evt(ble_lbs_t * p_lbs, ble_evt_t * p_ble_evt);
 ...
 */
uint32_t ble_wcc_on_button_change(ble_lbs_t * p_lbs, uint8_t button_state);
